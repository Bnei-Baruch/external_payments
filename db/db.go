...
func initDB() (err error) {
	...
	ALTER TABLE hmarket_subscription_history ADD COLUMN IF NOT EXISTS change_type VARCHAR(20) NOT NULL DEFAULT '';`),
		heredoc.Doc(`
	ALTER TABLE civicrm_bb_ext_requests ADD COLUMN IF NOT EXISTS pstatus VARCHAR(255) NOT NULL DEFAULT 'new';`),
		heredoc.Doc(`
	ALTER TABLE civicrm_bb_ext_requests ADD COLUMN IF NOT EXISTS paypal_order_id VARCHAR(64);`),
		heredoc.Doc(`
