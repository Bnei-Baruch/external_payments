...
var messages = map[string]string{
	...
	"510": "Data not exist.",
	"511": "Merchant Authorization failed - the customer received sms that needs to confirm and needs to send transaction again.",
	"555": "Cancel url status code.",
	"600": "General EMV terminals error – please contact support team.",
